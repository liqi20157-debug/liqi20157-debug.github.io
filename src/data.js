...
export const profile = {
  nameEn: "Qi Li",
  nameCn: "李琪",
  role: ["博士后研究人员", "中国科学院青岛生物能源与过程研究所"],
  location: "青岛，中国",
  politicalStatus: "政治面貌：中共党员",
  photo,
  links: [
    { label: "邮箱：liqi_2015@163.com", href: "mailto:liqi_2015@163.com" },
  ],
};

export const about = [
  `现为中国科学院青岛生物能源与过程研究所博士后研究人员，合作导师为高军研究员。主要从事仿生功能膜与离子选择性传输研究。`,
  `研究面向清洁能源转换与关键金属资源分离需求，聚焦纳米限域环境下离子快速迁移与精准分离。通过仿生通道设计与界面化学调控，探索离子传输与选择性识别机制，建立材料结构与传输分离性能之间的关联。`,
  `研究材料包括 COFs、MOFs、氧化石墨烯、MXene 与蛭石，重点关注二维限域传输、离子选择性和传输机理，应用于盐差能转换、酸性废水资源化与盐湖提锂。`,
];
...
export const education = [
  {
    org: "四川大学",
    role: "工学博士，材料与化工；联合培养：中国科学院青岛生物能源与过程研究所",
  ...
  },
  {
    ...
    url: "https://www.nwnu.edu.cn/",
  },
  {
    org: "兰州文理学院",
    role: "理学学士，应用化学",
    date: "2013.09–2017.06",
    url: "https://www.luas.edu.cn/",
  },
];
...
export const publications = [
  ...
  {
    title: "Defect-Tolerant and Scalable Diffusio-Osmotic Power Generation with Sulfonated Covalent Organic Framework Membrane",
    authors: "Shangfa Pan, <strong>Qi Li</strong>, Qianqian Fu, et al.",
    venue: "<em>Angewandte Chemie International Edition</em> 64, e202514637 (2025)",
  ...
  {
    title: "Artificial Proton Channel Membrane with Self-Amplified Selectivity for Simultaneous Waste Acid Recovery and Power Generation",
    authors: "Min Jian, Xuan Ding, <strong>Qi Li</strong>, et al.",
    venue: "<em>ACS Nano</em> 19, 16405–16414 (2025)",
    links: [{ label: "DOI", href: "https://doi.org/10.1021/acsnano.4c16985" }],
  },
];
...
export const experience = [
  {
    org: "博士后",
    desc: "二维超离子传输通道构建、一价离子分离及盐湖提锂研究",
    role: "中国科学院青岛生物能源与过程研究所",
    date: "2025.07–至今",
    url: "https://www.qibebt.cas.cn/",
  },
  {
    org: "科研助理",
    desc: "人工钠离子通道用于增强的渗透能收集研究",
    role: "中国科学院青岛生物能源与过程研究所",
...
export const projects = [
  ...
  {
    org: "仿生膜堆栈高电压生成机制与低能耗盐湖提锂技术研究",
    role: "中国博士后科学基金面上资助，主持，8 万元",
    date: "2026.06–2028.05",
  },
  {
    org: "仿生离子通道的构筑及其性能研究",
    role: "青岛市博士后项目资助（一等），主持，10 万元",
    date: "2026.07–2027.07",
  },
  {
    org: "仿生离子通道盐差能转换材料与关键技术研究",
    role: "国家重点研发计划项目课题/子课题，参与，600 万元",
    date: "2022.11–2025.10",
  },
];
...
export const awards = [
  { org: "优秀博士后", role: "中国科学院青岛生物能源与过程研究所", date: "2026" },
  { org: "国家奖学金", role: "四川大学", date: "2024" },
  { org: "青能橡塑奖学金", role: "中国科学院青岛生物能源与过程研究所", date: "2024" },
  { org: "学术之星", role: "西北师范大学", date: "2019" },
  { org: "挑战杯二等奖", role: "第十二届课外学术科技作品竞赛", date: "2018" },
  { org: "化学竞赛优胜奖", role: "第三届甘肃省大学生化学竞赛", date: "2015" },
];

export const teaching = [];

export const lastUpdated = "2026 年 9 月";
